(defsystem suturo-demos
  ...
  ((:module "src"
            ...
            ((:file "package")
			 ...
			 (:file "gpsr-ln" :depends-on ("package" "gpsr-knowledge")) ;; MN
    		 (:file "gpsr-pub" :depends-on ("package")) ;;MN
    		 (:file "gpsr-plans" :depends-on ("package" "gpsr-ln" "gpsr-knowledge")) ;;MN
     		 (:file "gpsr-knowledge" :depends-on ("package")) ;;MN
